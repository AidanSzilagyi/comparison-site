...
urlpatterns = [
    ...
    path("create/manual", views.create_or_edit_list, name="manual_create"),
    path("create/images-only", views.create_or_edit_list, name="images_only_create"),
    ...
    path("<slug:slug>/edit/", views.create_or_edit_list, name="list_edit"),
